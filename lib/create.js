...
const indexJs = require('../templates/express');
...
function createRouteFile(routeName, routePath, fileName) {
  const targetRouterFile = path.join(routePath, fileName);
  const indexFile = indexJs(routeName);
  console.log(indexFile)
  fs.writeFileSync(targetRouterFile, indexFile, 'utf8');
